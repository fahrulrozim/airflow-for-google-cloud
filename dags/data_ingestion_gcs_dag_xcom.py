# dags/data_ingestion_gcs_dag_xcom
...
# PROJECT_ID = "psychic-force-362917"
# BUCKET = "test-fellowship7"
...
with DAG(
    dag_id="data_ingestion_gcs_dag_xcom",
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f"curl -sSL {dataset_url} > '{path_to_local_home}/{dataset_file}'", #-o {os.path.join(os.getcwd(), dataset_file)} #bash_command=f"curl -sSL {dataset_url} -o os.getcwd(/airflow/{dataset_file})" #{path_to_local_home}/{dataset_file}"
        do_xcom_push=False
    )
    ...
    download_dataset_task >> training_model_task >> choose_model >> format_to_parquet_task >> local_to_gcs_task 
